...
must_haves:
  truths:
    - "All 66 scripts load via their existing `source common.sh` line unchanged"
...
Output: 8 new files in scripts/lib/ plus a rewritten scripts/common.sh entry point. All 66 consumer scripts continue to work with their existing source line.
</objective>
