...
description: "Trace network paths, analyze per-hop latency, and compare ICMP, TCP, and UDP routing with traceroute and mtr. Includes path visualization examples."
sidebar:
  order: 15
---
