...
- [John the Ripper](/tools/john/) -- alternative cracker with different strengths (CPU-focused, auto-detect hash types)
- [SQLMap](/tools/sqlmap/) -- extracts database hashes for cracking
