...
description: "Hashcat is the world's fastest password cracker using GPU acceleration. Crack NTLM, bcrypt, and web hashes with examples, rules, and benchmarking scripts."
sidebar:
  order: 11
---
