...
description: "TCP/UDP connections, port scanning, banner grabbing, file transfer, and reverse shells with Netcat. Variant-aware examples for ncat, nc, and netcat."
sidebar:
  order: 6
---
...
<Tabs syncKey="os">
  <TabItem label="macOS" icon="apple">
    ...
    Pre-installed on macOS (`nc` is the OpenBSD variant).
