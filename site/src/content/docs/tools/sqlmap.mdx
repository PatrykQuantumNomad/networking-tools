...
- [Nikto](/tools/nikto/) -- discover SQL injection points before targeted testing
- [Nmap](/tools/nmap/) -- find web servers to test for injection
- [Hashcat](/tools/hashcat/) -- crack password hashes extracted from databases
- [John the Ripper](/tools/john/) -- crack extracted hashes with auto-detection
