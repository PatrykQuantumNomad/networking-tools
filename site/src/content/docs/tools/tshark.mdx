...
description: TShark is the CLI version of Wireshark for capturing and analyzing network traffic. Filter packets, extract credentials, and decode protocols with examples.
sidebar:
  order: 2
---
