...
- [Nmap](/tools/nmap/) -- generate network traffic to capture and analyze
- [curl](/tools/curl/) -- capture HTTP request/response details in transit
- [Netcat](/tools/netcat/) -- monitor raw TCP/UDP connections
