...
- [gobuster](/tools/gobuster/) -- directory enumeration and DNS subdomain discovery (simpler but focused)
- [nikto](/tools/nikto/) -- web server vulnerability scanner (checks known vulnerabilities, not brute-force)
- [sqlmap](/tools/sqlmap/) -- after finding parameters with ffuf, test them for SQL injection
