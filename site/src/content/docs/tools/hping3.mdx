...
description: "hping3 crafts and sends custom TCP, UDP, and ICMP packets. Test firewall rules, detect filtering, perform traceroutes, and probe hosts with examples."
sidebar:
  order: 3
---
