...
- [dig](/tools/dig/) -- resolve DNS before testing HTTP endpoints
- [Nikto](/tools/nikto/) -- automated scanning complements manual HTTP testing
- [tshark](/tools/tshark/) -- capture HTTP traffic for deeper analysis
