...
- [Nmap](/tools/nmap/) -- import scan results to identify exploitable services
- [SQLMap](/tools/sqlmap/) -- follow up SQL injection findings with exploitation
- [Nikto](/tools/nikto/) -- web vulnerability findings guide exploit selection
