---
title: "Foremost — File Carving & Recovery"
description: Foremost recovers deleted and embedded files from disk images, memory dumps, and raw data by matching known file header and footer signatures
sidebar:
  order: 14
---
