...
description: Discover live hosts, scan open ports, detect services and OS versions with Nmap. Includes 10 examples and task scripts for the Docker practice lab.
sidebar:
  order: 1
---
...
- [tshark](/tools/tshark/) -- capture and analyze traffic from nmap scans
- [Nikto](/tools/nikto/) -- scan web services discovered by nmap
- [Metasploit](/tools/metasploit/) -- import nmap XML output for exploitation
- [hping3](/tools/hping3/) -- crafted packet probes complement nmap port scanning
