...
description: "Aircrack-ng is a complete WiFi security auditing suite. Capture handshakes, crack WPA/WPA2 keys, analyze wireless networks, and monitor traffic with examples."
sidebar:
  order: 13
---
