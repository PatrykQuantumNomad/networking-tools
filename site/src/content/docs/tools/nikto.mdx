...
- [Nmap](/tools/nmap/) -- discover web ports and services before scanning
- [Skipfish](/tools/skipfish/) -- alternative web scanner with crawling and active testing
- [SQLMap](/tools/sqlmap/) -- test SQL injection points found by Nikto
