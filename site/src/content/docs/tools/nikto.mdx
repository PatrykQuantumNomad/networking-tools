...
description: Nikto scans web servers for known vulnerabilities, dangerous files, outdated software, and misconfigurations. Includes authenticated and multi-host examples.
sidebar:
  order: 7
---
